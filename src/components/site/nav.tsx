  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50">
      ...
      >
        ...
        <a
          href="#contact"
          className="border border-foreground/30 px-2.5 min-[400px]:px-3 py-1.5 text-[0.58rem] tracking-[0.24em] text-foreground transition-colors hover:bg-foreground hover:text-background focus-visible:outline-2 focus-visible:outline-offset-3 md:hidden"
          style={{ borderRadius: "3px" }}
        >
          CONTACT
        </a>
      </nav>
        <div aria-hidden="true" className="w-11 shrink-0 min-[400px]:w-[6.5rem] sm:w-[7.5rem]" />
      </div>
    </header>
  );
}
